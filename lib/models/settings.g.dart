...
void _settingsSerialize(
  ...
  writer.writeLong(offsets[56], object.libraryFilterNovelBookMarkedType);
  writer.writeLong(offsets[57], object.libraryFilterNovelDownloadType);
  writer.writeLong(offsets[58], object.libraryFilterNovelStartedType);
  writer.writeLong(offsets[59], object.libraryFilterNovelUnreadType);
  writer.writeBool(offsets[60], object.libraryLocalSource);
  writer.writeBool(offsets[61], object.libraryShowCategoryTabs);
  writer.writeBool(offsets[62], object.libraryShowContinueReadingButton);
  writer.writeBool(offsets[63], object.libraryShowLanguage);
  writer.writeBool(offsets[64], object.libraryShowNumbersOfItems);
  ...
  writer.writeByte(offsets[67], object.mangaHomeDisplayType.index);
  writer.writeLong(offsets[68], object.markEpisodeAsSeenType);
  writer.writeByte(offsets[69], object.novelDisplayType.index);
  writer.writeLong(offsets[70], object.novelGridSize);
  writer.writeBool(offsets[71], object.novelLibraryDownloadedChapters);
  writer.writeBool(offsets[72], object.novelLibraryLocalSource);
  writer.writeBool(offsets[73], object.novelLibraryShowCategoryTabs);
  ...
  writer.writeBool(offsets[76], object.novelLibraryShowNumbersOfItems);
  writer.writeBool(offsets[77], object.onlyIncludePinnedSources);
  writer.writeLong(offsets[78], object.pagePreloadAmount);
  ...
  writer.writeBool(offsets[82], object.pureBlackDarkMode);
  writer.writeLong(offsets[83], object.relativeTimesTamps);
  writer.writeBool(offsets[84], object.saveAsCBZArchive);
  writer.writeByte(offsets[85], object.scaleType.index);
  writer.writeBool(offsets[86], object.showPagesNumber);
  ...
  writer.writeLong(offsets[91], object.startDatebackup);
  writer.writeBool(offsets[92], object.syncAfterReading);
  writer.writeBool(offsets[93], object.syncOnAppLaunch);
  writer.writeBool(offsets[94], object.themeIsDark);
  writer.writeBool(offsets[95], object.updateProgressAfterReading);
  writer.writeBool(offsets[96], object.useLibass);
  writer.writeBool(offsets[97], object.usePageTapZones);
  writer.writeString(offsets[98], object.userAgent);
}
...
Settings _settingsDeserialize(
  ...
  final object = Settings(
    ...
    libraryShowLanguage: reader.readBoolOrNull(offsets[63]),
    libraryShowNumbersOfItems: reader.readBoolOrNull(offsets[64]),
    mangaGridSize: reader.readLongOrNull(offsets[66]),
    ...
    pureBlackDarkMode: reader.readBoolOrNull(offsets[82]),
    relativeTimesTamps: reader.readLongOrNull(offsets[83]),
    saveAsCBZArchive: reader.readBoolOrNull(offsets[84]),
    scaleType:
        _SettingsscaleTypeValueEnumMap[reader.readByteOrNull(offsets[85])] ??
            ScaleType.fitScreen,
    showPagesNumber: reader.readBoolOrNull(offsets[86]),
    ...
    themeIsDark: reader.readBoolOrNull(offsets[94]),
    updateProgressAfterReading: reader.readBoolOrNull(offsets[95]),
    useLibass: reader.readBoolOrNull(offsets[96]),
    usePageTapZones: reader.readBoolOrNull(offsets[97]),
    userAgent: reader.readStringOrNull(offsets[98]),
  );
  object.chapterFilterBookmarkedList =

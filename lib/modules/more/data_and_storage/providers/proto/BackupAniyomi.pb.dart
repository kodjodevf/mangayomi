...
class BackupAniyomi extends $pb.GeneratedMessage {
  ...
  factory BackupAniyomi.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BackupAniyomi.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackupAniyomi', createEmptyInstance: create)
    ...
    ..pc<$2.BackupAnime>(3, _omitFieldNames ? '' : 'backupAnime', $pb.PbFieldType.PM, protoName: 'backupAnime', subBuilder: $2.BackupAnime.create)
    ..pc<$1.BackupCategory>(4, _omitFieldNames ? '' : 'backupAnimeCategories', $pb.PbFieldType.PM, protoName: 'backupAnimeCategories', subBuilder: $1.BackupCategory.create)
    ..pc<$3.BackupSource>(101, _omitFieldNames ? '' : 'backupSources', $pb.PbFieldType.PM, protoName: 'backupSources', subBuilder: $3.BackupSource.create)
    ..pc<$3.BackupSource>(103, _omitFieldNames ? '' : 'backupAnimeSources', $pb.PbFieldType.PM, protoName: 'backupAnimeSources', subBuilder: $3.BackupSource.create)
  ...
  'Will be removed in next major version')
  BackupAniyomi copyWith(void Function(BackupAniyomi) updates) => super.copyWith((message) => updates(message as BackupAniyomi)) as BackupAniyomi;
  ...
  static $pb.PbList<BackupAniyomi> createRepeated() => $pb.PbList<BackupAniyomi>();
  @$core.pragma('dart2js:noInline')
  static BackupAniyomi getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BackupAniyomi>(create);

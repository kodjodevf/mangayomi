...
/// [Settings] always syncs to other devices (see sync_server.dart), and this
/// collection must never be swept up in that - it's local-device-only,
/// opt-in, and only ever populated after the user has explicitly
/// acknowledged storing it unencrypted.
@collection
